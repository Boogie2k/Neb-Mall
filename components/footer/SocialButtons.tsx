		...
		<>
			...
			<div className='page-footer__social-buttons'>
				<div className='page-footer__social-button'>
					<a className='page-footer__social-link' target='_blank' href='https://fb.com/benjamin.edoma.1'>
				...
				<div className='page-footer__social-button'>
					<a className='page-footer__social-link' target='_blank' href='https://twitter.com/oghosa_benjamin'>
						<FontAwesomeIcon className='social-icon' icon={faTwitter}/>
					</a>
				</div>
			</div>
			<p className='page-footer__social-buttons company-info'>
				All rights reserved. © NebTech-mall
			</p>
		</>
	);
}